...
The [Final English Acceptance V2 results](ml/evaluation/FINAL_ENGLISH_ACCEPTANCE_V2_RESULTS.md) and [failure analysis](ml/evaluation/FINAL_ENGLISH_ACCEPTANCE_V2_FAILURES.md) preserve the frozen Smart Search evaluation. All eight multimodal queries pass at rank 1, but Speech Top-5 is 70.00%; explicit diagnostics show strong Speech evidence displaced during Hybrid fusion. The accepted next step is a bounded Hybrid-fusion investigation on new development evidence, never on the acceptance source.
