...
Semantic Transcript Retrieval + Hierarchical Evidence Selection V1 tested a separate local MiniLM/FAISS evidence architecture without connecting it to production. It improved evidence-package completeness from 80.30% to 89.39% and reduced false abstention, but answer correctness fell from 69.70% to 63.64% and long-video success was 36.36%. Decision B rejects integration. See its [protocol](../ml/evaluation/SEMANTIC_HIERARCHICAL_QA_V1_PROTOCOL.md), [results](../ml/evaluation/SEMANTIC_HIERARCHICAL_QA_V1_RESULTS.md), and [failures](../ml/evaluation/SEMANTIC_HIERARCHICAL_QA_V1_FAILURES.md).

Hierarchical Video Memory V1 replaced fixed three-unit context with deterministic semantic sections and persistent extractive navigation memory. Summaries retained full provenance and never entered generation or citations. Frozen validation reached 90.91% Section R@3, including 100% on the 40-minute source, but hierarchical evidence completeness was 84.85% and Core User Success 57.58%; one 22-minute source fell to 27.27%. Decision C rejects integration and prohibits automatic V2 tuning. See its [protocol](../ml/evaluation/HIERARCHICAL_VIDEO_MEMORY_V1_PROTOCOL.md), [results](../ml/evaluation/HIERARCHICAL_VIDEO_MEMORY_V1_RESULTS.md), and [failures](../ml/evaluation/HIERARCHICAL_VIDEO_MEMORY_V1_FAILURES.md).
