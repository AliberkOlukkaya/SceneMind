...
Limits: 250 MiB, 30 minutes, 4K, one ingestion at a time, five-minute FFmpeg timeout. FFmpeg comes from imageio-ffmpeg wheels; IMAGEIO_FFMPEG_EXE can override its path. Some platforms may need a separately installed binary. Check FFmpeg build licensing before redistributing binaries; this repository does not vendor one.
